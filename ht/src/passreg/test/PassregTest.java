 ...
 * @version 2021.04.13 12:53:59 // Generated by ComTest
 *
 */
...
public class PassregTest {
  ...
  public void testLueTiedostosta205() {    // Passreg: 205
    ...
    assertEquals("From: Passreg line: 244", true, filePaasyt.delete()); 
    File file_kategoriat = new File(hakemisto + "/kategoriat.dat"); 
    assertEquals("From: Passreg line: 246", true, file_kategoriat.delete()); 
    assertEquals("From: Passreg line: 247", true, dir.delete()); 
  } // Generated by ComTest END


  // Generated by ComTest BEGIN
  /** testPoistaKategoria268 */
  @Test
  public void testPoistaKategoria268() {    // Passreg: 268
    ...
    assertEquals("From: Passreg line: 277", 3, psg.getPaasytLkm()); 
    assertEquals("From: Passreg line: 278", "gmail", psg.annaPaasy(0).anna(1)); 
    Kategoria k1 = new Kategoria(); 
    k1.parse("1|tyo"); 
    Kategoria k2 = new Kategoria(); 
    k2.parse("2|opiskelu"); 
    psg.lisaa(k1); psg.lisaa(k2); 
    assertEquals("From: Passreg line: 284", 2, psg.getKategoriatLkm()); 
    psg.poistaKategoria(1); 
    assertEquals("From: Passreg line: 286", 1, psg.getKategoriatLkm()); 
    assertEquals("From: Passreg line: 287", 1, psg.getPaasytLkm()); 
    assertEquals("From: Passreg line: 288", p3, psg.annaPaasy(0)); 
    assertEquals("From: Passreg line: 289", k2, psg.annaKategoria(0)); 
  } // Generated by ComTest END
  ...
  /** testGetPaasyt302 */
  @Test
  public void testGetPaasyt302() {    // Passreg: 302
    ...
    Paasy p = i.next(); 
    assertEquals("From: Passreg line: 315", true, (p == p1 || p == p2)); 
    assertEquals("From: Passreg line: 316", true, i.hasNext()); 
    i.next(); 
    assertEquals("From: Passreg line: 318", false, i.hasNext()); 
    try {
    i.next(); 
    fail("Passreg: 319 Did not throw NoSuchElementException");
    } catch(NoSuchElementException _e_){ _e_.getMessage(); }
  } // Generated by ComTest END
  ...
  /** testEtsi352 */
  @Test
  public void testEtsi352() {    // Passreg: 352
    Paasy p1 = new Paasy(); 
    p1.aseta(1, "gmail3"); 
    Paasy p2 = new Paasy(); 
    p2.aseta(1, "gmail1"); 
    ...
    assertEquals("From: Passreg line: 363", p2, i.next()); 
    loytyneet = psg.etsi("gmail2", 1); 
    i = loytyneet.iterator(); 
    assertEquals("From: Passreg line: 366", p3, i.next()); 
    assertEquals("From: Passreg line: 367", false, i.hasNext()); 
  } // Generated by ComTest END


  // Generated by ComTest BEGIN
  /** testKorvaaTaiLisaa377 */
  @Test
  public void testKorvaaTaiLisaa377() {    // Passreg: 377
    Passreg psg = new Passreg(); 
    assertEquals("From: Passreg line: 379", false, psg.onMuutettu()); 
    Paasy p1 = new Paasy(); 
    p1.parse("1|1|gmail1"); 
    psg.korvaaTaiLisaa(p1); 
    assertEquals("From: Passreg line: 383", true, psg.onMuutettu()); 
    assertEquals("From: Passreg line: 384", "gmail1", psg.annaPaasy(0).anna(1)); 
    p1.parse("1|2|facebook"); 
    psg.korvaaTaiLisaa(p1); 
    assertEquals("From: Passreg line: 387", "facebook", psg.annaPaasy(0).anna(1)); 
  } // Generated by ComTest END


  // Generated by ComTest BEGIN
  /** testKorvaaTaiLisaa397 */
  @Test
  public void testKorvaaTaiLisaa397() {    // Passreg: 397
    Passreg psg = new Passreg(); 
    Kategoria k1 = new Kategoria("tyo"); 
    Kategoria k2 = new Kategoria("opiskelu"); 
    assertEquals("From: Passreg line: 401", false, psg.onMuutettu()); 
    psg.lisaa(k1); 
    psg.lisaa(k2); 
    assertEquals("From: Passreg line: 404", "tyo", psg.annaKategoria(0).getNimi()); 
    k1.parse("1|viihde"); 
    psg.korvaaTaiLisaa(k1); 
    assertEquals("From: Passreg line: 407", "viihde", psg.annaKategoria(0).getNimi()); 
    assertEquals("From: Passreg line: 408", true, psg.onMuutettu()); 
  } // Generated by ComTest END
  ...
  /** testGetName419 */
  @Test
  public void testGetName419() {    // Passreg: 419
    Passreg psg = new Passreg(); 
    psg.setTiedostonNimi("toinenTesti"); 
    assertEquals("From: Passreg line: 422", "toinenTesti", psg.getName()); 
  } // Generated by ComTest END


  // Generated by ComTest BEGIN
  /** testAnnaKategoriat433 */
  @Test
  public void testAnnaKategoriat433() {    // Passreg: 433
    Passreg psg = new Passreg(); 
    Kategoria k1 = new Kategoria("tyo"); 
    Kategoria k2 = new Kategoria("opiskelu"); 
    psg.lisaa(k1); psg.lisaa(k2); 
    ...
    assertEquals("From: Passreg line: 441", k2, i.next()); 
    assertEquals("From: Passreg line: 442", true, i.hasNext()); 
    assertEquals("From: Passreg line: 443", k1, i.next()); 
    assertEquals("From: Passreg line: 444", false, i.hasNext()); 
  } // Generated by ComTest END
}